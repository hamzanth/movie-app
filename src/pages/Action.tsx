...
const Action = () => {
    ...
    if(searchTerm){
        console.log("Ther is search term " + searchTerm)
        return allMovies.filter(movie =>
            movie.genres.includes("Action") && movie.originalTitle.toLowerCase().includes(searchTerm.toLowerCase())
        );
    }
    else{
        return allMovies.filter(movie =>
    ...
    return (
        <div className="pt-24">
            <h1 className="text-center text-xl">Action Movies</h1>
